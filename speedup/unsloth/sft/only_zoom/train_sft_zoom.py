...
class TrainConfig:
    ...
    train_jsonl: str = str(VQA_ROOT / "json_data" / "zoom_json" / "sft_verified_zoom.jsonl")
...
def parse_args():
    ...
    p.add_argument("--train_jsonl", default=str(VQA_ROOT / "json_data" / "zoom_json" / "sft_verified_zoom.jsonl"))
