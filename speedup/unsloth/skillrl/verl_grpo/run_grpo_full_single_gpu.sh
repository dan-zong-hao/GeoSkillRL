...
OUTPUT_DIR="${OUTPUT_DIR:-output/geoskill_verl_grpo_zoom_only_single_gpu_v1}"
ROLLOUT_LOG_PATH="${ROLLOUT_LOG_PATH:-logs/geoskill_verl_grpo_zoom_only_single_gpu_v1_rollouts.jsonl}"
...
"$PYTHON" train_geo_grpo_zoomearth.py \
  ...
  --run_name "${RUN_NAME:-geoskill_verl_grpo_zoom_only_single_gpu_v1}"
